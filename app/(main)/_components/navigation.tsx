    ...
    return (
        <>
            <aside ref={sidebarRef} className={cn(
                ...
                isResting && "transition-all duration-300 ease-in-out",
                isMobile && "w-0"
            )}>

            <div role="button" className={cn("h-6 w-6 text-muted-foreground rounded-sm hover:bg-neutral-300 dark:hover:bg-neutral-600 absolute top-3 right-2 opacity-0 group-hover/sidebar:opacity-100",
            ...
            <div className={cn(
                ...
                <nav className="bg-transprent px-3 py-2 w-full">
